...
ADJECTIVES: list = ["amazing", "funny", "boring", "exciting", "weird", "crazy", "scary"]
ACTIONS: list = ["found", "saw", "tried", "shared", "loved", "listen", "cook", "laugh"]
TOPICS: list = ["a movie", "a meme", "an app", "a trick", "a story", "a game", "a plan", "a sport"]
